          ...
          >
           ...
           <View style={styles.content}>
            ...
            <View style={styles.profileImageContainer}>
              <TouchableOpacity disabled={loading} style={styles.imagePickerContainer} onPress={pickImageAsync}>
                {imageSource ? (
