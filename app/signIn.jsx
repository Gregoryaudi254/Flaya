...
const signIn = () => {
  ...
  const { signIn, signInGoogle, isAuthenticated, user , isAccountexist } = useAuth();
  ...
  useEffect(() => {
    if (!user?.isAnonymous && isAuthenticated && isAccountexist === true) {
      console.log("isauthenticated");
      router.replace('/(tabs)')
    } else if (!user?.isAnonymous && isAuthenticated && isAccountexist === false) {
      router.replace('/usernameinput')
    }
  }, [isAuthenticated, user, isgooglesign, isAccountexist]);
