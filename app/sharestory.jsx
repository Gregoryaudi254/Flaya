import { StyleSheet, Text, View,Image,TextInput,Switch ,TouchableOpacity, ActivityIndicator,TouchableWithoutFeedback} from 'react-native'
                  ...
                  await new Promise((resolve, reject) => {
                    ...
                    uploadTask.on(
                      ...
                      async () => {
                          const downloadURL = await getDownloadURL(uploadTask.snapshot.ref);
                          urls.push(downloadURL); // Add the download URL to the list
                          dispatch(finishUpload()); // Call finishUpload on successful upload
